        ...
        builder: (context, state) {
          ...
          return Scaffold(
            body: ConditionalBuilder(
              ...
              builder: (BuildContext context) => ListView.builder(itemBuilder: (context,index){
                 ...
                 return ListTile(
                   ...
                   onTap: (){
                     NavigateTo(context, PatientDetails(Mo:DoctorCubit.get(context).Test.data[index] ,));
                ...
                ExpansionWidget(
                    ...
                    return InkWell(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                             Expanded(child: Text('voting ' , style: Theme.of(context).textTheme.bodyText1,)),
                            Transform.rotate(
                              angle: math.pi * animationValue / 2,
                              // السهم بيلف يدررجة كام
                              child:
                              const Icon(Icons.arrow_right, size: 40 , color: Colors.deepOrange,),
                  ...
                  content: SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        RadioListTile(
                            title:  Text('covid19' , style: Theme.of(context).textTheme.bodyText1,),
                            value: 'covid19',
                        ...
                        RadioListTile(
                          title:  Text('none' , style: Theme.of(context).textTheme.bodyText1),
                          value: 'none',
                          groupValue: DoctorCubit.get(context).value1,
                          onChanged: (index2) {
                            DoctorCubit.get(context)
                        ...
                        RadioListTile(
                            title:  Text('Pneumonia' ,  style: Theme.of(context).textTheme.bodyText1),
                            value: 'pneumonia',
                            groupValue: DoctorCubit.get(context).value1,
                            onChanged: (index3) {
                              DoctorCubit.get(context)
